...
<head>
    ...
    <!-- Local Styles -->
    <link rel="stylesheet" href="./css/local-styles/add-content-to-collection.css">
...
<body>
    ...
    <div id="add-content-to-collection-main-content">

        <div class="page-header-container">
            <p id="page-header-title">Add Content to Collection</p>
        </div>
        ...
        <div class="wrapper">
            ...
            <!-- ADD CONTENT TO COLLECTION INFORMATION -->

            <div class="content-container">

                <div class="add-content-to-collection-headers-container">
                    <div class="block-a"> </div>
                    <div class="block-b">Title</div>
                    <div class="block-c">Creator</div>
                    <div class="block-d">Type</div>
                    <div class="block-e">Date</div>
                    <div class="block-f">Action</div>
                </div>

                <div class="add-content-to-collection-container">
                    <div class="add-content-to-collection-info">
                        <div class="block-a">
                            <p>
    ...
    <script src="./javascript/add-content-to-collection.js"></script>
